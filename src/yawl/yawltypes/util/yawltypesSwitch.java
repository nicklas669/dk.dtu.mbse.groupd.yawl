 ...
 * @generated
 */
public class yawltypesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case yawltypesPackage.AND: {
				And and = (And)theEObject;
				T result = caseAnd(and);
				if (result == null) result = caseType(and);
				if (result == null) result = caseAttribute(and);
				if (result == null) result = caseLabel(and);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case yawltypesPackage.OR: {
				Or or = (Or)theEObject;
				T result = caseOr(or);
				if (result == null) result = caseType(or);
				if (result == null) result = caseAttribute(or);
				if (result == null) result = caseLabel(or);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case yawltypesPackage.XOR: {
				Xor xor = (Xor)theEObject;
				T result = caseXor(xor);
				if (result == null) result = caseType(xor);
				if (result == null) result = caseAttribute(xor);
				if (result == null) result = caseLabel(xor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case yawltypesPackage.START: {
				Start start = (Start)theEObject;
				T result = caseStart(start);
				if (result == null) result = casePlace(start);
				if (result == null) result = casePnmlcoremodel_Place(start);
				if (result == null) result = casePlaceNode(start);
				if (result == null) result = caseNode(start);
				if (result == null) result = caseObject(start);
				if (result == null) result = caseID(start);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case yawltypesPackage.END: {
				End end = (End)theEObject;
				T result = caseEnd(end);
				if (result == null) result = casePlace(end);
				if (result == null) result = casePnmlcoremodel_Place(end);
				if (result == null) result = casePlaceNode(end);
				if (result == null) result = caseNode(end);
				if (result == null) result = caseObject(end);
				if (result == null) result = caseID(end);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case yawltypesPackage.YAW_LNET: {
			...
			case yawltypesPackage.RESET_ARC: {
				ResetArc resetArc = (ResetArc)theEObject;
				T result = caseResetArc(resetArc);
				if (result == null) result = caseArc(resetArc);
				if (result == null) result = casePnmlcoremodel_Arc(resetArc);
				if (result == null) result = caseObject(resetArc);
				if (result == null) result = caseID(resetArc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Reset Arc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Reset Arc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResetArc(ResetArc object) {
		return null;
	}
