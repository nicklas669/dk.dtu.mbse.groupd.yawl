 ...
 * </p>
 * <ul>
 *   <li>{@link yawlnet.yawltypes.impl.TransitionTypeImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionTypeImpl extends AttributeImpl implements TransitionType {
	...
	protected EClass eStaticClass() {
		return YawltypesPackage.Literals.TRANSITION_TYPE;
	}
	...
	public void setText(TransitionTypes newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YawltypesPackage.TRANSITION_TYPE__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YawltypesPackage.TRANSITION_TYPE__TEXT:
				return getText();
		}
