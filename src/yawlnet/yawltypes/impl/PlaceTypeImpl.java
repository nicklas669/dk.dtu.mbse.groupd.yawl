 ...
 * </p>
 * <ul>
 *   <li>{@link yawlnet.yawltypes.impl.PlaceTypeImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceTypeImpl extends AttributeImpl implements PlaceType {
	...
	protected EClass eStaticClass() {
		return YawltypesPackage.Literals.PLACE_TYPE;
	}
	...
	public void setText(PlaceTypes newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YawltypesPackage.PLACE_TYPE__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YawltypesPackage.PLACE_TYPE__TEXT:
				return getText();
		}
