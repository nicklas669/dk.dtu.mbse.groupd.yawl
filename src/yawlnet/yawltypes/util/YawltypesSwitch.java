...
public class YawltypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case YawltypesPackage.TRANSITION_TYPE: {
			...
			case YawltypesPackage.PLACE_TYPE: {
			...
			case YawltypesPackage.ARC_TYPE: {
			...
			case YawltypesPackage.YAWL_NET_ARC_ANNOTATION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>YAWL Net Arc Annotation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>YAWL Net Arc Annotation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
